...
# --------------------------------------------------
# GLOBAL SWITCH (default = existing behavior)
# --------------------------------------------------
...
def verlet_step(t, y, masses, tf, dt, radii, contact_state, k):
    ...
    while t < tf:
        ...
        if ENABLE_COLLISIONS:
            y, contact_state, k = collision.collision(
                y, masses, radii, contact_state, k
            )
...
def rk4(f, t, y, tf, dt, masses, radii, contact_state, k):
    ...
    while t < tf:
        ...
        if ENABLE_COLLISIONS:
            y_new, contact_state, k = collision.collision(
                y_old, masses, radii, contact_state, k
            )
        else:
            y_new = y_old
